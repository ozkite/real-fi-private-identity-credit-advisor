          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-white border-4 border-navy-900 brutalist-shadow p-8 space-y-8">
              <article className="space-y-8">
                ...
                <div className={`overflow-hidden transition-all duration-500 ease-in-out ${isExpanded ? 'max-h-none' : 'max-h-0'}`}>
                    ...
                    <div className="space-y-6">
                      <div>
                        ...
                        <ul className="list-disc list-inside text-navy-700 leading-relaxed space-y-2 mb-4">
                          <li>
                            <strong>nilCC</strong> is used to host the backend of nilGPT, ensuring no third-party cloud provider can access execution logs or user data. nilCC runs a secure enclave (TEE) on a bare metal server, meaning that all the standard protections of TEEs apply, and no third party cloud provider can see logs or outputs
                          </li>
                          <li>
                            <strong>nilAI</strong> is used for inference when the user queries nilGPT. nilAI runs inside nilCC and provides private AI inference for developers via an OpenAI-compatible RESTful API. Models served in nilAI are loaded into a hardware-protected enclave (TEE), and neither the input queries nor the model responses are ever exposed to the host system or external observers.
                          </li>
                          <li>
                            <strong>nilDB</strong> is used to store chat history, so the user can access it at a future date. The history is encrypted with a user supplied passphrase and then stored in secret-shared form across a decentralised cluster of nilDB nodes (each operated by a distinct entity).
                          </li>
                        </ul>
                        <p className="text-navy-700 leading-relaxed mb-4">
