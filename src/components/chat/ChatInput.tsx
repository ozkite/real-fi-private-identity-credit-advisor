  ...
  return (
    <div className="w-full">
      <form onSubmit={handleSubmit} className="relative flex flex-col">
        <div className="relative flex items-end bg-white border border-neutral-200 rounded-2xl shadow-sm hover:shadow-md transition-all duration-200 p-4">
          <textarea
            ref={textareaRef}
            rows={1}
            value={input}
            ...
            className="w-full px-4 py-3 pr-12 bg-transparent text-neutral-800 placeholder-neutral-400 resize-none focus:outline-none text-base leading-6 min-h-[48px] max-h-32 overflow-y-auto"
            style={{
              scrollbarWidth: "none",
              height: "auto",
              minHeight: "48px",
          ...
          <button
            ...
            className={`absolute right-3 bottom-5 w-10 h-10 flex items-center justify-center rounded-lg transition-colors duration-200 ${
